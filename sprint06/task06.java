 ...
 * as a first parameter and Predicate as a second. This method should return an integer value,
 * evaluated from User's field values using the first and second parameters of getFilterdValue(...) method.
 * One more method that needs to be implemented in User class is getMaxValueByCondition(...).
 * This method has one Predicate parameter. The implementation should call getFilterdValue(...) method with
